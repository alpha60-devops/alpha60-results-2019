---
layout: default
title: "Alpha60 Swarm Results 2019"
...
- Media Objects
{% capture media_objects %}{% include year-2019-0-media-objects.txt %}{% endcapture %}{{ media_objects | replace: '.md)', '.html)' }}
...
- [Year-2019 data](https://github.com/alpha60-devops/alpha60-results-2019/tree/main/data)
