...
### <a href="https://raw.githubusercontent.com/alpha60-devops/alpha60-results-2019/refs/heads/main/data/geojson.cumulative/permanent-record-cumulative-aggregate.geojson.gz" data-map-title="Permanent Record — permanent-record" onclick="leaflet_map_open_window(this.href, this.dataset.mapTitle); return false;" class="table-link" aria-label="Open Permanent Record (permanent-record) cumulative data map in new window" title="Opens interactive map for Permanent Record (permanent-record) data">Swarm Detail</a>
