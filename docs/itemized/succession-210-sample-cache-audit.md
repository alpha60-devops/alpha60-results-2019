...
### <a href="https://raw.githubusercontent.com/alpha60-devops/alpha60-results-2019/refs/heads/main/data/geojson.cumulative/succession-210-cumulative-aggregate.geojson.gz" data-map-title="Succession — succession-210" onclick="leaflet_map_open_window(this.href, this.dataset.mapTitle); return false;" class="table-link" aria-label="Open Succession (succession-210) cumulative data map in new window" title="Opens interactive map for Succession (succession-210) data">Swarm Detail</a>
