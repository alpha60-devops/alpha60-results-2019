...
### <a href="https://raw.githubusercontent.com/alpha60-devops/alpha60-results-2019/refs/heads/main/data/geojson.cumulative/black-monday-110-cumulative-aggregate.geojson.gz" data-map-title="Black Monday — black-monday-110" onclick="leaflet_map_open_window(this.href, this.dataset.mapTitle); return false;" class="table-link" aria-label="Open Black Monday (black-monday-110) cumulative data map in new window" title="Opens interactive map for Black Monday (black-monday-110) data">Swarm Detail</a>
