...
### <a href="https://raw.githubusercontent.com/alpha60-devops/alpha60-results-2019/refs/heads/main/data/geojson.cumulative/true-detective-308-cumulative-aggregate.geojson.gz" data-map-title="True Detective — true-detective-308" onclick="leaflet_map_open_window(this.href, this.dataset.mapTitle); return false;" class="table-link" aria-label="Open True Detective (true-detective-308) cumulative data map in new window" title="Opens interactive map for True Detective (true-detective-308) data">Swarm Detail</a>
