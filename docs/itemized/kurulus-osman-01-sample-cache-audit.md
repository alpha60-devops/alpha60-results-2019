...
### <a href="https://raw.githubusercontent.com/alpha60-devops/alpha60-results-2019/refs/heads/main/data/geojson.cumulative/kurulus-osman-01-cumulative-aggregate.geojson.gz" data-map-title="Kurulus Osman — kurulus-osman-01" onclick="leaflet_map_open_window(this.href, this.dataset.mapTitle); return false;" class="table-link" aria-label="Open Kurulus Osman (kurulus-osman-01) cumulative data map in new window" title="Opens interactive map for Kurulus Osman (kurulus-osman-01) data">Swarm Detail</a>
