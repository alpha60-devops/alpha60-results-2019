...
### <a href="https://raw.githubusercontent.com/alpha60-devops/alpha60-results-2019/refs/heads/main/data/geojson.cumulative/star-trek-discovery-201-cumulative-aggregate.geojson.gz" data-map-title="Star Trek Discovery — star-trek-discovery-201" onclick="leaflet_map_open_window(this.href, this.dataset.mapTitle); return false;" class="table-link" aria-label="Open Star Trek Discovery (star-trek-discovery-201) cumulative data map in new window" title="Opens interactive map for Star Trek Discovery (star-trek-discovery-201) data">Swarm Detail</a>
