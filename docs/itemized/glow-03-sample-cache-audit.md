...
### <a href="https://raw.githubusercontent.com/alpha60-devops/alpha60-results-2019/refs/heads/main/data/geojson.cumulative/glow-03-cumulative-aggregate.geojson.gz" data-map-title="GLOW — glow-03" onclick="leaflet_map_open_window(this.href, this.dataset.mapTitle); return false;" class="table-link" aria-label="Open GLOW (glow-03) cumulative data map in new window" title="Opens interactive map for GLOW (glow-03) data">Swarm Detail</a>
