...
### <a href="https://raw.githubusercontent.com/alpha60-devops/alpha60-results-2019/refs/heads/main/data/geojson.cumulative/dolemite-is-my-name-cumulative-aggregate.geojson.gz" data-map-title="Dolemite Is My Name — dolemite-is-my-name" onclick="leaflet_map_open_window(this.href, this.dataset.mapTitle); return false;" class="table-link" aria-label="Open Dolemite Is My Name (dolemite-is-my-name) cumulative data map in new window" title="Opens interactive map for Dolemite Is My Name (dolemite-is-my-name) data">Swarm Detail</a>
